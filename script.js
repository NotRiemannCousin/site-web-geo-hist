...
window.addEventListener('load', () => {
    ...
    for (i = 0; i < paths.length; i++) {
        paths[i].addEventListener('mouseenter', e => {
            if (selectedMap != null) //  && e.currentTarget != selectedMap
                return;
        ...
        paths[i].addEventListener('mousemove', e => {
            ...
            showResume = setTimeout(() => {
                ...
                resume.style.top = (mousePos.y < document.body.clientHeight - document.body.clientWidth * 0.2 ? mousePos.y + 1 : mousePos.y - document.body.clientWidth * 0.2) + 'px';
                resume.style.left = (mousePos.x < document.body.clientWidth * 0.8 ? mousePos.x + 1 : mousePos.x - document.body.clientWidth * 0.2) + 'px';
            }, 500);
        });
        ...
        paths[i].addEventListener('click', e => {
            ...
            if ((selectedMap != null && e.currentTarget != selectedMap) || mapChanging == true)
                return;
